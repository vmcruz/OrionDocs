...
#Region "Variables de version"
    ...
    Public buildDate As String = "2017.08.04" '# Cambiar con cada build de trabajo diaria
...
#End Region
    ...
    Sub Main()
        ...
        'CompileProject()
        If argc - 1 > 0 Then
            '# Para cualquier tipo de sintaxis de ayuda, arrojar la ayuda de OrionDocs
            ...
            ElseIf argv(1).ToLower = "--easteregg" Then
                '#VAMOS A METER UN HUEVO DE PASCUA
                Console.WriteLine(" ▒█████   ██▀███   ██▓ ▒█████   ███▄    █ ▓█████▄  ▒█████   ▄████▄    ██████ ")
                Console.WriteLine("▒██▒  ██▒▓██ ▒ ██▒▓██▒▒██▒  ██▒ ██ ▀█   █ ▒██▀ ██▌▒██▒  ██▒▒██▀ ▀█  ▒██    ▒ ")
                Console.WriteLine("▒██░  ██▒▓██ ░▄█ ▒▒██▒▒██░  ██▒▓██  ▀█ ██▒░██   █▌▒██░  ██▒▒▓█    ▄ ░ ▓██▄   ")
                Console.WriteLine("▒██   ██░▒██▀▀█▄  ░██░▒██   ██░▓██▒  ▐▌██▒░▓█▄   ▌▒██   ██░▒▓▓▄ ▄██▒  ▒   ██▒")
    ...
    Sub CompileProject(ByVal argumentList As String())
        ...
        ElseIf mainOTT.IndexOf("{LOADMENU:") > -1 Then
            Console.WriteLine("OrionDocs: Couldn't find the menu template. Will be empty.")
        End If
    ...
    Public Sub ShowHelp()
        ...
        Console.WriteLine("                  Else, OrionDocs will use 'Default Project' as title")
        Console.WriteLine("Wizard mode: " + Path.GetFileName(Process.GetCurrentProcess().MainModule.FileName).Replace(".exe", "") + " /w")
        Console.WriteLine("   This launches the wizard interface mode.")
    End Sub
End Module
